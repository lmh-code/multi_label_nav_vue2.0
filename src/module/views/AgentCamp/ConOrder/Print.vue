<template>
  <div class="print-page">
    ...
    <div class="print-content" ref="printContent">
        ...
        <el-row :gutter="5">
          <el-col :span="17">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <span>所在地址: {{orderMsg.storeAddress || '--'}}</span>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
      ...
      <print-table 
        v-if="orderSumTableData && orderSumTableData.length > 0"
        class="print-table" 
        :pages="false"
        :propsList="propsList" 
        :tableData="orderSumTableData"/>
      <print-table 
        v-if="storeGoodsTableData && storeGoodsTableData.length > 0"
        class="print-table mt10" 
        :pages="false"
        :propsList="propsListForStoreGoods" 
        :tableData="storeGoodsTableData"/>
...
export default {
  ...
  methods: {
    ...
    getStoreGoodsTableColumn() {
      let tableColumn = [...this.storeGoodsTableColumn]
      this.propsListForStoreGoods = tableColumn.map(item => {
        return {
          name: item.title,
          props: item.dataIndex
        }
